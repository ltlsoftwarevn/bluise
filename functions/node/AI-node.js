...
const gambit = require("./gambit-node");
...
AI.init = function (pace) {
  var bill = AI.historyBill || gambit; //开局库
  if (bill.length) {
    var len = pace.length;
    var arr = [];
    //先搜索棋谱
  ...
  if (val && val.value != -8888) {
    ...
    //   "<h3>AI搜索结果：</h3>最佳着法：" +
    //   com.createMove(AI.arr2Clone(play.map), man.x, man.y, val.x, val.y) +
    //   "<br />搜索深度：" +
    //   AI.treeDepth +
    //   "<br />搜索分支：" +
    //   AI.number +
